/**
 * Mapeo de ejercicios a imágenes locales para el frontend.
 * Replica de server/_core/exerciseImages.ts para uso client-side.
 * Las imágenes están en client/public/exercises/ y se sirven en /exercises/{filename}
 */
...
export function getPlaceholderByMuscleGroup(muscleGroup: string | undefined): string {
  if (!muscleGroup) return "/exercises/placeholder-default.png";
  const mg = muscleGroup.toLowerCase();
  if (mg.includes("chest") || mg.includes("pecho")) return "/exercises/placeholder-chest.png";
  if (mg.includes("back") || mg.includes("espalda")) return "/exercises/placeholder-back.png";
  if (mg.includes("leg") || mg.includes("pierna") || mg.includes("glute") || mg.includes("calf")) return "/exercises/placeholder-legs.png";
  if (mg.includes("shoulder") || mg.includes("hombro")) return "/exercises/placeholder-shoulders.png";
  if (mg.includes("arm") || mg.includes("bicep") || mg.includes("tricep") || mg.includes("brazo")) return "/exercises/placeholder-arms.png";
  if (mg.includes("core") || mg.includes("abdom") || mg.includes("abs")) return "/exercises/placeholder-core.png";
  if (mg.includes("cardio") || mg.includes("mobility")) return "/exercises/placeholder-cardio.png";
  return "/exercises/placeholder-default.png";
}
